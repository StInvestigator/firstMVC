...
namespace firstMVC.Areas.Users.Controllers
{
    [Area("Users")]
    [Authorize(Roles = "User")]
    public class UserSkillController(SiteContext _context, UserManager<Customer> _userManager) : Controller
    {
